Feature: Text Message Network
    ...
    Scenario: Alice can update a message subject
        ...
        And I submit the following transaction
            """
            [
            {"$class":"org.message.mynetwork.updateSubject", "oldMessage":"org.message.mynetwork.Message#001", "newSubject":"Goodbye All!"}
            ]
            """
        Then I should have the following assets
            """
            [
            {"$class":"org.message.mynetwork.Message", "messageId":"001", "creator":"org.message.mynetwork.Member#alice@email.com", "subject":"Goodbye All!", "value":"This is a test"}
            ]
            """
    ...
    Scenario: Alice can update a message value
        ...
        Then I should have the following assets
            """
            [
            {"$class":"org.message.mynetwork.Message", "messageId":"001", "creator":"org.message.mynetwork.Member#alice@email.com", "subject":"Hello There!", "value":"This is not a test"}
            ]
            """
    ...
    Scenario: Alice can not update Bob's message value
        When I use the identity alice1
        And I submit the following transaction
            """
            [
